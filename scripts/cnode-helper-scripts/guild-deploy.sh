...
download_cnodebins() {
  ...
  curl -m 200 -sfL https://github.com/intersectmbo/cardano-node/releases/download/8.7.2/cardano-node-8.7.2-linux.tar.gz -o cnode.tar.gz || err_exit " Could not download cardano-node's latest release archive from IO CI builds at update-cardano-mainnet.iohk.io!"
